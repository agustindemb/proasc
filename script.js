...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const botAnswers = {
    ...
    pricing: "Cada negocio tiene necesidades diferentes, por lo que cotizamos según la complejidad:\n\n• **Asistente de WhatsApp Estándar**: desde USD 600\n• **IA Conversacional con Base de Datos**: desde USD 1.200\n• **Integraciones y APIs a Medida**: desde USD 2.000\n\n*Completa el formulario al final de la página y te enviaremos una propuesta de presupuesto personalizada.*"
  };
